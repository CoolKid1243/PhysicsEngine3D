...
public:
    ...
    // Wave settings
    // Wave A
    inline static glm::vec2 waveDirectionA = glm::normalize(glm::vec2(1.0f, 1.0f));
    inline static float waveSteepnessA = 0.25f;
    inline static float waveLengthA = 6.0f;
    // Wave B
    inline static glm::vec2 waveDirectionB = glm::normalize(glm::vec2(1.0f, 0.6f));
    inline static float waveSteepnessB = 0.25f;
    inline static float waveLengthB = 3.1f;
    // Wave C
